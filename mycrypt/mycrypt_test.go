...
func TestKrypter(t *testing.T) {
	...
	tests := []test{
		...
		/*
			...
			{inputMessage: []rune("b"), chiffer: 38, want: []rune("K")},
		*/
		/*
			{inputMessage: []rune("d"), chiffer: 36, want: []rune("K")}, //GODKJENT
			{inputMessage: []rune("S"), chiffer: 4, want: []rune("W")},
			{inputMessage: []rune("N"), chiffer: 4, want: []rune("R")},
		*/
	}
